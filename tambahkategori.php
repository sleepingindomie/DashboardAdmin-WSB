...
<head>
    ...
    <title>Tambah Kategori | WSB</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <h1 class="h3 mb-2 text-gray-800">Form Tambah Kategori</h1>
                    <form method="POST" action="tkategori.php">
                        <div class="mb-3 row">
                            <label for="inputEmail3" class="col-sm-2 col-form-label">Id Kategori</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputEmail3" name="id_kategori">
                            </div>
                        </div>
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            <label for="inputtelp3" class="col-sm-2 col-form-label">Tanggal</label>
                            <div class="col-sm-10">
                                <input type="datetime-local" class="form-control" id="inputEmail3" name="tgl">
                            </div>
                        </div>
